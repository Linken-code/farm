...
## [0.1.3](https://github.com/Linken-code/farm/compare/create_farm_node-v0.1.2...create_farm_node-v0.1.3) - 2024-09-30

### Other

- Version Packages ([#1722](https://github.com/Linken-code/farm/pull/1722))
- Version Packages ([#1703](https://github.com/Linken-code/farm/pull/1703))
- *(create-farm)* add multiple platforms ([#1689](https://github.com/Linken-code/farm/pull/1689))
