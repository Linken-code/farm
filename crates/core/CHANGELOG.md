...
## [0.4.2](https://github.com/Linken-code/farm/compare/farmfe_core-v0.4.1...farmfe_core-v0.4.2) - 2024-03-23

### Added
- farm e2e test ([#1041](https://github.com/Linken-code/farm/pull/1041)) ([#1049](https://github.com/Linken-code/farm/pull/1049))
- minify modules instead of resource pots ([#1025](https://github.com/Linken-code/farm/pull/1025))

### Other
- support glob brace ([#1055](https://github.com/Linken-code/farm/pull/1055))
