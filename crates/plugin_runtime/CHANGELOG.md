...
## [0.0.6](https://github.com/Linken-code/farm/compare/farmfe_plugin_runtime-v0.0.5...farmfe_plugin_runtime-v0.0.6) - 2024-04-30

### Added
- support lazy compilation when targeting node ([#1035](https://github.com/Linken-code/farm/pull/1035))
- support top level await ([#1202](https://github.com/Linken-code/farm/pull/1202))

### Fixed
- minify module filter use absolute path ([#1259](https://github.com/Linken-code/farm/pull/1259))
- vite migrations bugs ([#1236](https://github.com/Linken-code/farm/pull/1236))

### Other
- Fix/lazy compilation ([#1253](https://github.com/Linken-code/farm/pull/1253))
- update swc to v0.90 ([#1227](https://github.com/Linken-code/farm/pull/1227))
- add ssr e2e tests ([#1201](https://github.com/Linken-code/farm/pull/1201))
