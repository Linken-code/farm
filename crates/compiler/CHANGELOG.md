...
## [0.0.12](https://github.com/Linken-code/farm/compare/farmfe_compiler-v0.0.11...farmfe_compiler-v0.0.12) - 2024-09-30

### Fixed

- html runtime inject failed when build multiple page ([#1760](https://github.com/Linken-code/farm/pull/1760))
- globalThis undefined ([#1726](https://github.com/Linken-code/farm/pull/1726))
- [#1672](https://github.com/Linken-code/farm/pull/1672) ([#1692](https://github.com/Linken-code/farm/pull/1692))
- bundle import namespace name uniq ([#1696](https://github.com/Linken-code/farm/pull/1696))
- single bundle ([#1653](https://github.com/Linken-code/farm/pull/1653))

### Other

- *(refactor)* refactor stats and visualizer ([#1739](https://github.com/Linken-code/farm/pull/1739))
- remove `query_string` when `emit_file` to `resource_map` in `plugin_static_assets` ([#1746](https://github.com/Linken-code/farm/pull/1746))
