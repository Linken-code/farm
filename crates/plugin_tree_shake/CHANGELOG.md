...
## [0.0.2](https://github.com/Linken-code/farm/compare/farmfe_plugin_tree_shake-v0.0.1...farmfe_plugin_tree_shake-v0.0.2) - 2024-03-23

### Added
- remove if (import.meta.hot) guard for production ([#1030](https://github.com/Linken-code/farm/pull/1030))

### Fixed
- add remove import meta hot condition ([#1056](https://github.com/Linken-code/farm/pull/1056))
- tree shake variable assign ([#1054](https://github.com/Linken-code/farm/pull/1054))
- treeshake class decl assign ([#1038](https://github.com/Linken-code/farm/pull/1038))
