...
## [0.0.12](https://github.com/Linken-code/farm/compare/farmfe_plugin_polyfill-v0.0.11...farmfe_plugin_polyfill-v0.0.12) - 2024-09-30

### Fixed

- revert preset-env match & add enforce exclude ([#1752](https://github.com/Linken-code/farm/pull/1752))
